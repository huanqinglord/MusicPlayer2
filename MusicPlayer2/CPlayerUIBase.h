...
public:
    ...
    void DrawUIButton(const CRect& rect, UIButton& btn, IconMgr::IconType icon_type, bool big_icon = false, const std::wstring& text = std::wstring(), int font_size = 9, bool checked = false, Alignment align = Alignment::LEFT, bool btn_background = false, bool force_round_background = false, IconMgr::IconSize icon_size = IconMgr::IS_ALL);
